...
<body style="font-family: Arial, sans-serif; background-color: #f4f4f4; margin: 0; padding: 20px;">
    ...
    <div style="max-width: 600px; margin: auto; background-color: #ffffff; padding: 20px; border-radius: 8px; box-shadow: 0px 0px 10px rgba(0, 0, 0, 0.1);">
        ...
        <p>We’re excited to welcome you to {{ config('app.name') }}! You’ve been added as a support to a property managed by {{ $landlord }}, and an account has been created for you on our platform.</p>
